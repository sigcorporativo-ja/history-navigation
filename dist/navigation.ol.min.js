...
a("es6-impl",function(){return!0});a("es7",function(){return b("2 ** 2 == 4")});a("es8",function(){return b("async () => 1, true")});return c};var P={templates:{}};P.templates.miplugin={};(function(a){a.template.add("miplugin.html",Handlebars.template({compiler:[7,">= 4.0.0"],main:function(a,c,d,e,f){return'<div class="m-miplugin">\r\n   <button id="m-miplugincontrol-button">Show message</button>\r\n</div>\r\n'},useData:!0}))})(window.M);P.templates.navigation={};
...
useData:!0}))})(window.M);goog.debug={};goog.debug.Error=function(a){if(Error.captureStackTrace)Error.captureStackTrace(this,goog.debug.Error);else{var b=Error().stack;b&&(this.stack=b)}a&&(this.message=String(a));this.reportErrorToServer=!0};goog.inherits(goog.debug.Error,Error);goog.debug.Error.prototype.name="CustomError";goog.dom={};goog.dom.NodeType={ELEMENT:1,ATTRIBUTE:2,TEXT:3,CDATA_SECTION:4,ENTITY_REFERENCE:5,ENTITY:6,PROCESSING_INSTRUCTION:7,COMMENT:8,DOCUMENT:9,DOCUMENT_TYPE:10,DOCUMENT_FRAGMENT:11,NOTATION:12};goog.string={};goog.string.DETECT_DOUBLE_ESCAPING=!1;goog.string.FORCE_NON_DOM_HTML_UNESCAPING=!1;goog.string.Unicode={NBSP:"\u00a0"};goog.string.startsWith=function(a,b){return 0==a.lastIndexOf(b,0)};goog.string.endsWith=function(a,b){var c=a.length-b.length;return 0<=c&&a.indexOf(b,c)==c};goog.string.caseInsensitiveStartsWith=function(a,b){return 0==goog.string.caseInsensitiveCompare(b,a.substr(0,b.length))};
...
goog.style.getCssTranslation=function(a){a=goog.style.getComputedTransform(a);return a?(a=a.match(goog.style.MATRIX_TRANSLATION_REGEX_))?new goog.math.Coordinate(parseFloat(a[1]),parseFloat(a[2])):new goog.math.Coordinate(0,0):new goog.math.Coordinate(0,0)};P.control={};P.control.NavigationControl={};M.control.NavigationControl=function(a,b){M.Control.call(this,a,b)};goog.inherits(M.control.NavigationControl,M.Control);M.control.NavigationControl.prototype.createView=function(a){var b=this;return new Promise(function(c,d){M.template.compile(a,{}).then(function(a){b.addEvents(a);c(a)})})};M.control.NavigationControl.prototype.addEvents=function(a){this.element_=a;this.on(M.evt.COMPLETED,function(){goog.dom.classlist.add(this.element_,"shown")},this)};
M.control.NavigationControl.prototype.equals=function(a){var b=!1;a instanceof M.control.NavigationControl&&(b=this.name===a.name);return b};M.control.NavigationControl.prototype.destroy=function(){this.getImpl().destroy()};M.control.NavigationControl.closestResolution=function(a,b){var c=1E3,d=0;for(d in a){var e=Math.abs(b-a[d]);if(e<c){c=e;var f=a[d]}}return f};M.control.NavigationControl.NAME="navigationcontrol";P.control.NavigationCoordinates={};M.control.NavigationCoordinates=function(){M.utils.isUndefined(M.impl.control.NavigationCoordinates)&&M.exception("La implementaci\u00f3n usada no puede crear controles NavigationCoordinates");var a=new M.impl.control.NavigationCoordinates;this.impl_=a;M.utils.isUndefined(this.impl_.centerByCoords)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo centerByCoords");this.coordYInput_=this.coordXInput_=null;M.control.NavigationControl.call(this,a,M.control.NavigationCoordinates.NAME)};
goog.inherits(M.control.NavigationCoordinates,M.control.NavigationControl);M.control.NavigationCoordinates.prototype.createView=function(){return M.control.NavigationCoordinates.superClass_.createView.call(this,M.control.NavigationCoordinates.TEMPLATE)};
M.control.NavigationCoordinates.prototype.addEvents=function(a){this.coordXInput_=a.getElementsByTagName("input")["m-navigation-coordinateX-input"];this.coordYInput_=a.getElementsByTagName("input")["m-navigation-coordinateY-input"];var b=a.getElementsByTagName("button")["m-navigationcoordinatesapply-button"];goog.events.listen(b,goog.events.EventType.CLICK,this.onCenterApply,!1,this);a=a.getElementsByTagName("button")["m-navigationcoordinatesclear-button"];goog.events.listen(a,goog.events.EventType.CLICK,
this.onCenterClear,!1,this)};M.control.NavigationCoordinates.prototype.onCenterApply=function(){this.impl_.centerByCoords(Number(this.coordXInput_.value),Number(this.coordYInput_.value))};M.control.NavigationCoordinates.prototype.onCenterClear=function(){this.coordXInput_.value="";this.coordYInput_.value="";this.impl_.centerClear()};M.control.NavigationCoordinates.NAME="navigationcoordinates";M.control.NavigationCoordinates.TEMPLATE="navigationCoordinates.html";P.control.NavigationScale={};
M.control.NavigationScale=function(a,b){M.utils.isUndefined(M.impl.control.NavigationScale)&&M.exception("La implementaci\u00f3n usada no puede crear controles NavigationScale");this.scaleConfig=b||{};if(M.utils.isNullOrEmpty(this.scaleConfig)||M.utils.isNullOrEmpty(this.scaleConfig.scales))this.scaleConfig.scales=M.control.NavigationScale.SCALES;this.impl_=a=new M.impl.control.NavigationScale(this.scaleConfig);M.utils.isUndefined(this.impl_.zoomToScale)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo zoomToScale");M.control.NavigationControl.call(this,
a,M.control.NavigationScale.NAME)};goog.inherits(M.control.NavigationScale,M.control.NavigationControl);M.control.NavigationScale.prototype.createView=function(){return M.control.NavigationScale.superClass_.createView.call(this,M.control.NavigationScale.TEMPLATE)};M.control.NavigationScale.prototype.addEvents=function(a){var b=a.getElementsByTagName("select")["m-navigationscale-select"];goog.events.listen(b,goog.events.EventType.CHANGE,this.onScaleChange,!1,this);this.addScaleOptions(a)};
M.control.NavigationScale.prototype.addScaleOptions=function(a){a=a.getElementsByTagName("select")["m-navigationscale-select"];for(var b=0;b<this.scaleConfig.scales.length;b++){var c=document.createElement("option");c.setAttribute("value",this.scaleConfig.scales[b]);var d=document.createTextNode("1:"+this.scaleConfig.scales[b]);c.appendChild(d);a.appendChild(c)}};M.control.NavigationScale.prototype.onScaleChange=function(a){this.impl_.zoomToScale(a.target.value)};
M.control.NavigationScale.SCALES=[1E3,2E3,5E3,1E4,25E3,5E4,1E5,15E4,25E4,5E5,1E6];M.control.NavigationScale.NAME="navigationscale";M.control.NavigationScale.TEMPLATE="navigationScale.html";P.control.NavigationZoomControl={};M.control.NavigationZoomControl=function(){M.utils.isUndefined(M.impl.control.NavigationZoomControl)&&M.exception("La implementaci\u00f3n usada no puede crear controles NavigationZoomControl");var a=new M.impl.control.NavigationZoomControl;this.impl_=a;M.utils.isUndefined(this.impl_.doZoom)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo doZoom");M.control.NavigationControl.call(this,a,M.control.NavigationZoomControl.NAME)};
goog.inherits(M.control.NavigationZoomControl,M.control.NavigationControl);M.control.NavigationZoomControl.prototype.createView=function(){return M.control.NavigationZoomControl.superClass_.createView.call(this,M.control.NavigationZoomControl.TEMPLATE)};
M.control.NavigationZoomControl.prototype.addEvents=function(a){var b=a.getElementsByTagName("button")["m-navigationzoomin-button"];goog.events.listen(b,goog.events.EventType.CLICK,this.onZoomInClick,!1,this);a=a.getElementsByTagName("button")["m-navigationzoomout-button"];goog.events.listen(a,goog.events.EventType.CLICK,this.onZoomOutClick,!1,this)};M.control.NavigationZoomControl.prototype.onZoomInClick=function(){this.impl_.doZoom(.5)};M.control.NavigationZoomControl.prototype.onZoomOutClick=function(){this.impl_.doZoom(2)};
M.control.NavigationZoomControl.NAME="navigationzoomcontrol";M.control.NavigationZoomControl.TEMPLATE="navigationZoomControl.html";P.control.NavigationZoomExtent={};M.control.NavigationZoomExtent=function(){M.utils.isUndefined(M.impl.control.NavigationZoomExtent)&&M.exception("La implementaci\u00f3n usada no puede crear controles NavigationZoomExtent");var a=new M.impl.control.NavigationZoomExtent;this.impl_=a;M.utils.isUndefined(this.impl_.zoomToExtent)&&M.exception("La implementaci\u00f3n usada no posee el m\u00e9todo zoomToExtent");M.control.NavigationControl.call(this,a,M.control.NavigationZoomExtent.NAME)};
goog.inherits(M.control.NavigationZoomExtent,M.control.NavigationControl);M.control.NavigationZoomExtent.prototype.createView=function(){return M.control.NavigationZoomExtent.superClass_.createView.call(this,M.control.NavigationZoomExtent.TEMPLATE)};M.control.NavigationZoomExtent.prototype.addEvents=function(a){a=a.getElementsByTagName("button")["m-navigationzoomextent-button"];goog.events.listen(a,goog.events.EventType.CLICK,this.onClick,!1,this)};
M.control.NavigationZoomExtent.prototype.onClick=function(){this.impl_.zoomToExtent()};M.control.NavigationZoomExtent.NAME="navigationzoomextent";M.control.NavigationZoomExtent.TEMPLATE="navigationZoomExtent.html";P.control.NavigationZoomHistory={};M.control.NavigationZoomHistory=function(){M.utils.isUndefined(M.impl.control.NavigationZoomHistory)&&M.exception("La implementaci\u00f3n usada no puede crear controles NavigationZoomHistory");var a=new M.impl.control.NavigationZoomHistory;M.control.NavigationControl.call(this,a,M.control.NavigationZoomHistory.NAME)};goog.inherits(M.control.NavigationZoomHistory,M.control.NavigationControl);
M.control.NavigationZoomHistory.prototype.createView=function(){return M.control.NavigationZoomHistory.superClass_.createView.call(this,M.control.NavigationZoomHistory.TEMPLATE)};M.control.NavigationZoomHistory.NAME="navigationzoomhistory";M.control.NavigationZoomHistory.TEMPLATE="navigationZoomHistory.html";P.impl={};P.impl.Navigation={};P.impl.Navigation.style={};
(function(){M.impl.Navigation={};M.impl.Navigation.style={};M.impl.Navigation.style.initialized=!1;M.impl.Navigation.style.init=function(){if(!1===M.impl.Navigation.style.initialized){M.impl.Navigation.style.initialized=!0;M.impl.Navigation.style.DEFAULT={};var a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,
imgSize:[24,24]})});M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#A15BD7"}),stroke:new ol.style.Stroke({color:"#A15BD7",width:2})});M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POLYGON]=new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.MULTI_POINT]=M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POINT];M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.LINEAR_RING]=
M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.MULTI_POLYGON]=M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.CIRCLE]=M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.GEOMETRY_COLLECTION]=M.impl.Navigation.style.DEFAULT[M.geom.wkt.type.POLYGON];
M.impl.Navigation.style.NEW={};a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24-new.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.Navigation.style.NEW[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.Navigation.style.NEW[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#e2951b"}),stroke:new ol.style.Stroke({color:"#e2951b",width:2})});M.impl.Navigation.style.NEW[M.geom.wkt.type.POLYGON]=
new ol.style.Style({image:new ol.style.Icon({img:a,imgSize:[24,24]})});M.impl.Navigation.style.NEW[M.geom.wkt.type.MULTI_POINT]=M.impl.Navigation.style.NEW[M.geom.wkt.type.POINT];M.impl.Navigation.style.NEW[M.geom.wkt.type.LINEAR_RING]=M.impl.Navigation.style.NEW[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.NEW[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.Navigation.style.NEW[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.NEW[M.geom.wkt.type.MULTI_POLYGON]=M.impl.Navigation.style.NEW[M.geom.wkt.type.POLYGON];
M.impl.Navigation.style.NEW[M.geom.wkt.type.CIRCLE]=M.impl.Navigation.style.NEW[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.NEW[M.geom.wkt.type.GEOMETRY_COLLECTION]=M.impl.Navigation.style.NEW[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.SELECTED={};a=document.createElement("IMG");a.src=M.utils.concatUrlPaths([M.config.THEME_URL,"/img/m-pin-24-sel.svg"]);a.width="24";a.height="24";a.crossOrigin="anonymous";M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POINT]=new ol.style.Style({image:new ol.style.Icon({img:a,
imgSize:[24,24]})});M.impl.Navigation.style.SELECTED[M.geom.wkt.type.LINE_STRING]=new ol.style.Style({fill:new ol.style.Fill({color:"#fcfcfc"}),stroke:new ol.style.Stroke({color:"#3589d1",width:2})});M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POLYGON]=new ol.style.Style({fill:new ol.style.Fill({color:"rgba(240, 220, 255, 0.2)"}),stroke:new ol.style.Stroke({color:"#a15bd7",width:2})});M.impl.Navigation.style.SELECTED[M.geom.wkt.type.MULTI_POINT]=M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POINT];
M.impl.Navigation.style.SELECTED[M.geom.wkt.type.LINEAR_RING]=M.impl.Navigation.style.SELECTED[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.SELECTED[M.geom.wkt.type.MULTI_LINE_STRING]=M.impl.Navigation.style.SELECTED[M.geom.wkt.type.LINE_STRING];M.impl.Navigation.style.SELECTED[M.geom.wkt.type.MULTI_POLYGON]=M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.SELECTED[M.geom.wkt.type.CIRCLE]=M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POLYGON];M.impl.Navigation.style.SELECTED[M.geom.wkt.type.GEOMETRY_COLLECTION]=
M.impl.Navigation.style.SELECTED[M.geom.wkt.type.POLYGON]}}})();P.impl.layer={};P.impl.layer.Navigation={};
(function(){M.impl.layer.Navigation=function(){this.map=null;this.name="navigation";M.impl.Layer.call(this,{})};goog.inherits(M.impl.layer.Navigation,M.impl.Layer);M.impl.layer.Navigation.prototype.addTo=function(a){M.impl.Navigation.style.init();this.map=a;this.ol3Layer=new ol.layer.Vector({source:new ol.source.Vector({useSpatialIndex:!1}),zIndex:M.impl.Map.Z_INDEX[M.layer.type.WFS]+999});this.setVisible(!0);this.map.getMapImpl().addLayer(this.ol3Layer)};M.impl.layer.Navigation.prototype.drawResults=
function(a,b){var c=ol.proj.get(this.map.getProjection().code),d=[];a=new ol.Feature({geometry:new ol.geom.Point([a,b]),dataProjection:c});d.push(a);M.impl.layer.Navigation.setStyleFeature_(d,M.style.state.DEFAULT);this.ol3Layer.getSource().addFeatures(d)};M.impl.layer.Navigation.prototype.clear=function(){this.ol3Layer.getSource().clear()};M.impl.layer.Navigation.prototype.destroy=function(){var a=this.map.getMapImpl();M.utils.isNullOrEmpty(this.ol3Layer)||(a.removeLayer(this.ol3Layer),this.ol3Layer=
null);this.name=this.map=null};M.impl.layer.Navigation.prototype.equals=function(a){var b=!1;a instanceof M.impl.layer.Navigation&&(b=(b=this.url===a.url)&&this.name===a.name);return b};M.impl.layer.Navigation.setStyleFeature_=function(a,b){M.impl.Navigation.style.init();M.utils.isArray(a)||(a=[a]);a.forEach(function(a){var c=a.getGeometry().getType();M.utils.isNullOrEmpty(b)||b===M.style.state.DEFAULT?a.setStyle(M.impl.Navigation.style.DEFAULT[c]):b===M.style.state.NEW?a.setStyle(M.impl.Navigation.style.NEW[c]):
b===M.style.state.SELECTED&&a.setStyle(M.impl.Navigation.style.SELECTED[c])})}})();P.impl.control={};P.impl.control.NavigationCoordinates={};M.impl.control.NavigationCoordinates=function(){this.element_=this.facadeMap_=null;this.layer_=new M.impl.layer.Navigation;M.impl.Control.call(this)};goog.inherits(M.impl.control.NavigationCoordinates,M.impl.Control);M.impl.control.NavigationCoordinates.prototype.addTo=function(a,b){this.facadeMap_=a;this.olMap=a.getMapImpl();this.layer_.addTo(a);M.impl.control.NavigationCoordinates.superClass_.addTo.call(this,a,b)};
M.impl.control.NavigationCoordinates.prototype.centerByCoords=function(a,b){this.centerClear();if(0!==a&&0!==b)if(this.containsCoords(a,b)){var c=this.facadeMap_.getMapImpl().getView(),d=[a,b];this.layer_.drawResults(a,b);a=this.facadeMap_.getResolutions();c.animate({center:d,resolution:a[a.length-2],duration:500})}else M.dialog.info("Las coordenadas se encuentran fuera de los l\u00edmites del mapa");else M.dialog.info("Introduzca unas coordenadas")};
M.impl.control.NavigationCoordinates.prototype.containsCoords=function(a,b){var c=this.facadeMap_.getMaxExtent();return ol.extent.containsCoordinate(c,[a,b])};M.impl.control.NavigationCoordinates.prototype.centerClear=function(){this.layer_.clear()};M.impl.control.NavigationCoordinates.prototype.getLayer=function(){return this.layer_};P.impl.control.NavigationScale={};M.impl.control.NavigationScale=function(a){this.facadeMap_=null;this.scaleConfig=a;M.impl.Control.call(this)};goog.inherits(M.impl.control.NavigationScale,M.impl.Control);
M.impl.control.NavigationScale.prototype.addTo=function(a,b){var c=this;this.facadeMap_=a;var d=this.scaleConfig.scales.map(function(a){return c.scaleToResolution(a)});this.facadeMap_.setResolutions(d.sort(this.sortNumber));this.updateSelector(b);a.getMapImpl().on("moveend",function(){c.updateSelector(b)});M.impl.control.NavigationScale.superClass_.addTo.call(this,a,b)};
M.impl.control.NavigationScale.prototype.zoomToScale=function(a){if("0"!==a){var b=this.facadeMap_.getMapImpl().getView();a=this.scaleToResolution(a);b.animate({center:b.getCenter(),resolution:a,duration:500})}};M.impl.control.NavigationScale.prototype.scaleToResolution=function(a){var b=this.facadeMap_.getMapImpl().getView().getProjection().getUnits();return a/(25.4/.35*ol.proj.METERS_PER_UNIT[b]*39)};
M.impl.control.NavigationScale.prototype.resolutionToScale=function(a){var b=this.facadeMap_.getMapImpl().getView().getProjection().getUnits();return 25.4/.35*a*ol.proj.METERS_PER_UNIT[b]*39};
M.impl.control.NavigationScale.prototype.updateSelector=function(a){var b=this.facadeMap_.getMapImpl().getView();b=Math.round(this.resolutionToScale(b.getResolution()));for(var c=a.querySelector("select"),d=1;d<a.getElementsByTagName("option").length;d++){var e=a.getElementsByTagName("option")[d];if(b==e.getAttribute("value")){c.selectedIndex=d;break}}};M.impl.control.NavigationScale.prototype.sortNumber=function(a,b){return b-a};P.impl.control.NavigationZoomControl={};M.impl.control.NavigationZoomControl=function(){M.impl.Control.call(this)};goog.inherits(M.impl.control.NavigationZoomControl,M.impl.Control);M.impl.control.NavigationZoomControl.prototype.addTo=function(a,b){M.impl.control.NavigationZoomControl.superClass_.addTo.call(this,a,b)};
M.impl.control.NavigationZoomControl.prototype.doZoom=function(a){a=1<a?!0:!1;var b=!a;var c=this.facadeMap_.getMapImpl().getView(),d=this.facadeMap_.getResolutions(),e=c.getResolution(),f=e;if(a&&0!==d.indexOf(e)||b&&d.indexOf(e)!=d.length-1)b=M.control.NavigationControl.closestResolution(d,e),f=a?d[d.indexOf(b)-1]:d[d.indexOf(b)+1];c.animate({center:c.getCenter(),resolution:f,duration:500})};P.impl.control.NavigationZoomExtent={};M.impl.control.NavigationZoomExtent=function(){M.impl.Control.call(this)};goog.inherits(M.impl.control.NavigationZoomExtent,M.impl.Control);M.impl.control.NavigationZoomExtent.prototype.addTo=function(a,b){M.impl.control.NavigationZoomExtent.superClass_.addTo.call(this,a,b)};M.impl.control.NavigationZoomExtent.prototype.zoomToExtent=function(){this.facadeMap_.zoomToMaxExtent()};P.impl.control.NavigationZoomHistory={};M.impl.control.NavigationZoomHistory=function(){this.facadeMap_=null;M.impl.Control.call(this)};goog.inherits(M.impl.control.NavigationZoomHistory,M.impl.Control);
M.impl.control.NavigationZoomHistory.prototype.addTo=function(a,b){this.facadeMap_=a;var c=this,d=!0;this.facadeMap_.getMapImpl().on("moveend",function(){if(d){var a=c.facadeMap_.getMapImpl().getView(),b=a.getCenter();b="#map="+a.getZoom()+"/"+Math.round(100*b[0])/100+"/"+Math.round(100*b[1])/100;a={center:a.getCenter(),resolution:a.getResolution()};window.history.pushState(a,"map",b)}else d=!0});window.addEventListener("popstate",function(a){M.utils.isUndefined(a.state)||null===a.state||(c.facadeMap_.getMapImpl().getView().animate({center:a.state.center,
resolution:a.state.resolution,duration:300}),d=!1)});var e=b.getElementsByTagName("button")["m-navigationzoomprevious-button"];goog.events.listen(e,goog.events.EventType.CLICK,this.onPreviousClick,!1,this);e=b.getElementsByTagName("button")["m-navigationzoomnext-button"];goog.events.listen(e,goog.events.EventType.CLICK,this.onNextClick,!1,this);M.impl.control.NavigationZoomHistory.superClass_.addTo.call(this,a,b)};M.impl.control.NavigationZoomHistory.prototype.onPreviousClick=function(){window.history.back()};
M.impl.control.NavigationZoomHistory.prototype.onNextClick=function(){window.history.forward()};P.plugin={};P.plugin.Navigation={};
(function(){M.plugin.Navigation=function(a){M.utils.isNullOrEmpty(a)&&M.exception("No ha especificado ning\u00fan par\u00e1metro");this.controls_=a.controls;this.config_=a.options;this.map_=null;M.Plugin.call(this)};goog.inherits(M.plugin.Navigation,M.Plugin);M.plugin.Navigation.prototype.addTo=function(a){var b=this;this.map_=a;this.controls_.unshift(new M.control.NavigationZoomControl);this.controls_.unshift(new M.control.NavigationZoomExtent);this.controls_.unshift(new M.control.NavigationZoomHistory);this.config_.scaleCtl&&
this.controls_.push(new M.control.NavigationScale(this.map_,this.config_.scaleConfig));this.config_.coordinatesCtl&&this.controls_.push(new M.control.NavigationCoordinates);this.panel_=new M.ui.Panel("navigation",{collapsible:!0,className:"m-navigation",collapsedButtonClass:"g-navigationtools-closed",openedButtonClass:"g-navigationtools-opened",position:M.ui.position.TL,tooltip:"Herramientas de navegaci\u00f3n"});this.panel_.on(M.evt.ADDED_TO_MAP,function(a){M.utils.enableTouchScroll(a);b.panel_.open()});
this.panel_.addControls(this.controls_);this.map_.addPanels(this.panel_)};M.plugin.Navigation.prototype.destroy=function(){this.map_.removeControls(this.controls_);this.map_=null};M.plugin.Navigation.prototype.getControls=function(){return this.controls_}})();goog.exportSymbol("M.control.NavigationControl",M.control.NavigationControl);goog.exportProperty(M.control.NavigationControl.prototype,"createView",M.control.NavigationControl.prototype.createView);goog.exportProperty(M.control.NavigationControl.prototype,"addEvents",M.control.NavigationControl.prototype.addEvents);goog.exportProperty(M.control.NavigationControl.prototype,"equals",M.control.NavigationControl.prototype.equals);goog.exportProperty(M.control.NavigationControl.prototype,"destroy",M.control.NavigationControl.prototype.destroy);
goog.exportSymbol("M.control.NavigationControl.closestResolution",M.control.NavigationControl.closestResolution);goog.exportSymbol("M.control.NavigationControl.NAME",M.control.NavigationControl.NAME);goog.exportSymbol("M.impl.control.NavigationCoordinates",M.impl.control.NavigationCoordinates);goog.exportProperty(M.impl.control.NavigationCoordinates.prototype,"addTo",M.impl.control.NavigationCoordinates.prototype.addTo);
goog.exportProperty(M.impl.control.NavigationCoordinates.prototype,"centerByCoords",M.impl.control.NavigationCoordinates.prototype.centerByCoords);goog.exportProperty(M.impl.control.NavigationCoordinates.prototype,"containsCoords",M.impl.control.NavigationCoordinates.prototype.containsCoords);goog.exportProperty(M.impl.control.NavigationCoordinates.prototype,"centerClear",M.impl.control.NavigationCoordinates.prototype.centerClear);
goog.exportProperty(M.impl.control.NavigationCoordinates.prototype,"getLayer",M.impl.control.NavigationCoordinates.prototype.getLayer);goog.exportSymbol("M.control.NavigationCoordinates",M.control.NavigationCoordinates);goog.exportProperty(M.control.NavigationCoordinates.prototype,"createView",M.control.NavigationCoordinates.prototype.createView);goog.exportProperty(M.control.NavigationCoordinates.prototype,"addEvents",M.control.NavigationCoordinates.prototype.addEvents);
goog.exportProperty(M.control.NavigationCoordinates.prototype,"onCenterApply",M.control.NavigationCoordinates.prototype.onCenterApply);goog.exportProperty(M.control.NavigationCoordinates.prototype,"onCenterClear",M.control.NavigationCoordinates.prototype.onCenterClear);goog.exportSymbol("M.control.NavigationCoordinates.NAME",M.control.NavigationCoordinates.NAME);goog.exportSymbol("M.control.NavigationCoordinates.TEMPLATE",M.control.NavigationCoordinates.TEMPLATE);
goog.exportSymbol("M.impl.layer.Navigation",M.impl.layer.Navigation);goog.exportProperty(M.impl.layer.Navigation.prototype,"addTo",M.impl.layer.Navigation.prototype.addTo);goog.exportProperty(M.impl.layer.Navigation.prototype,"drawResults",M.impl.layer.Navigation.prototype.drawResults);goog.exportProperty(M.impl.layer.Navigation.prototype,"clear",M.impl.layer.Navigation.prototype.clear);goog.exportProperty(M.impl.layer.Navigation.prototype,"destroy",M.impl.layer.Navigation.prototype.destroy);
goog.exportProperty(M.impl.layer.Navigation.prototype,"equals",M.impl.layer.Navigation.prototype.equals);goog.exportSymbol("M.plugin.Navigation",M.plugin.Navigation);goog.exportProperty(M.plugin.Navigation.prototype,"addTo",M.plugin.Navigation.prototype.addTo);goog.exportProperty(M.plugin.Navigation.prototype,"destroy",M.plugin.Navigation.prototype.destroy);goog.exportProperty(M.plugin.Navigation.prototype,"getControls",M.plugin.Navigation.prototype.getControls);
goog.exportSymbol("M.control.NavigationScale",M.control.NavigationScale);goog.exportProperty(M.control.NavigationScale.prototype,"createView",M.control.NavigationScale.prototype.createView);goog.exportProperty(M.control.NavigationScale.prototype,"addEvents",M.control.NavigationScale.prototype.addEvents);goog.exportProperty(M.control.NavigationScale.prototype,"addScaleOptions",M.control.NavigationScale.prototype.addScaleOptions);
goog.exportProperty(M.control.NavigationScale.prototype,"onScaleChange",M.control.NavigationScale.prototype.onScaleChange);goog.exportSymbol("M.control.NavigationScale.SCALES",M.control.NavigationScale.SCALES);goog.exportSymbol("M.control.NavigationScale.NAME",M.control.NavigationScale.NAME);goog.exportSymbol("M.control.NavigationScale.TEMPLATE",M.control.NavigationScale.TEMPLATE);goog.exportSymbol("M.impl.control.NavigationScale",M.impl.control.NavigationScale);
goog.exportProperty(M.impl.control.NavigationScale.prototype,"addTo",M.impl.control.NavigationScale.prototype.addTo);goog.exportProperty(M.impl.control.NavigationScale.prototype,"zoomToScale",M.impl.control.NavigationScale.prototype.zoomToScale);goog.exportProperty(M.impl.control.NavigationScale.prototype,"scaleToResolution",M.impl.control.NavigationScale.prototype.scaleToResolution);goog.exportProperty(M.impl.control.NavigationScale.prototype,"resolutionToScale",M.impl.control.NavigationScale.prototype.resolutionToScale);
goog.exportProperty(M.impl.control.NavigationScale.prototype,"updateSelector",M.impl.control.NavigationScale.prototype.updateSelector);goog.exportProperty(M.impl.control.NavigationScale.prototype,"sortNumber",M.impl.control.NavigationScale.prototype.sortNumber);goog.exportSymbol("M.control.NavigationZoomControl",M.control.NavigationZoomControl);goog.exportProperty(M.control.NavigationZoomControl.prototype,"createView",M.control.NavigationZoomControl.prototype.createView);
goog.exportProperty(M.control.NavigationZoomControl.prototype,"addEvents",M.control.NavigationZoomControl.prototype.addEvents);goog.exportProperty(M.control.NavigationZoomControl.prototype,"onZoomInClick",M.control.NavigationZoomControl.prototype.onZoomInClick);goog.exportProperty(M.control.NavigationZoomControl.prototype,"onZoomOutClick",M.control.NavigationZoomControl.prototype.onZoomOutClick);goog.exportSymbol("M.control.NavigationZoomControl.NAME",M.control.NavigationZoomControl.NAME);
goog.exportSymbol("M.control.NavigationZoomControl.TEMPLATE",M.control.NavigationZoomControl.TEMPLATE);goog.exportSymbol("M.impl.control.NavigationZoomControl",M.impl.control.NavigationZoomControl);goog.exportProperty(M.impl.control.NavigationZoomControl.prototype,"addTo",M.impl.control.NavigationZoomControl.prototype.addTo);goog.exportProperty(M.impl.control.NavigationZoomControl.prototype,"doZoom",M.impl.control.NavigationZoomControl.prototype.doZoom);
goog.exportSymbol("M.control.NavigationZoomExtent",M.control.NavigationZoomExtent);goog.exportProperty(M.control.NavigationZoomExtent.prototype,"createView",M.control.NavigationZoomExtent.prototype.createView);goog.exportProperty(M.control.NavigationZoomExtent.prototype,"addEvents",M.control.NavigationZoomExtent.prototype.addEvents);goog.exportProperty(M.control.NavigationZoomExtent.prototype,"onClick",M.control.NavigationZoomExtent.prototype.onClick);
goog.exportSymbol("M.control.NavigationZoomExtent.NAME",M.control.NavigationZoomExtent.NAME);goog.exportSymbol("M.control.NavigationZoomExtent.TEMPLATE",M.control.NavigationZoomExtent.TEMPLATE);goog.exportSymbol("M.impl.control.NavigationZoomExtent",M.impl.control.NavigationZoomExtent);goog.exportProperty(M.impl.control.NavigationZoomExtent.prototype,"addTo",M.impl.control.NavigationZoomExtent.prototype.addTo);goog.exportProperty(M.impl.control.NavigationZoomExtent.prototype,"zoomToExtent",M.impl.control.NavigationZoomExtent.prototype.zoomToExtent);
goog.exportSymbol("M.control.NavigationZoomHistory",M.control.NavigationZoomHistory);goog.exportProperty(M.control.NavigationZoomHistory.prototype,"createView",M.control.NavigationZoomHistory.prototype.createView);goog.exportSymbol("M.control.NavigationZoomHistory.NAME",M.control.NavigationZoomHistory.NAME);goog.exportSymbol("M.control.NavigationZoomHistory.TEMPLATE",M.control.NavigationZoomHistory.TEMPLATE);goog.exportSymbol("M.impl.control.NavigationZoomHistory",M.impl.control.NavigationZoomHistory);
goog.exportProperty(M.impl.control.NavigationZoomHistory.prototype,"addTo",M.impl.control.NavigationZoomHistory.prototype.addTo);goog.exportProperty(M.impl.control.NavigationZoomHistory.prototype,"onPreviousClick",M.impl.control.NavigationZoomHistory.prototype.onPreviousClick);goog.exportProperty(M.impl.control.NavigationZoomHistory.prototype,"onNextClick",M.impl.control.NavigationZoomHistory.prototype.onNextClick);goog.exportProperty(M.control.NavigationCoordinates.prototype,"equals",M.control.NavigationCoordinates.prototype.equals);
goog.exportProperty(M.control.NavigationCoordinates.prototype,"destroy",M.control.NavigationCoordinates.prototype.destroy);goog.exportProperty(M.control.NavigationScale.prototype,"equals",M.control.NavigationScale.prototype.equals);goog.exportProperty(M.control.NavigationScale.prototype,"destroy",M.control.NavigationScale.prototype.destroy);goog.exportProperty(M.control.NavigationZoomControl.prototype,"equals",M.control.NavigationZoomControl.prototype.equals);
goog.exportProperty(M.control.NavigationZoomControl.prototype,"destroy",M.control.NavigationZoomControl.prototype.destroy);goog.exportProperty(M.control.NavigationZoomExtent.prototype,"equals",M.control.NavigationZoomExtent.prototype.equals);goog.exportProperty(M.control.NavigationZoomExtent.prototype,"destroy",M.control.NavigationZoomExtent.prototype.destroy);goog.exportProperty(M.control.NavigationZoomHistory.prototype,"addEvents",M.control.NavigationZoomHistory.prototype.addEvents);
goog.exportProperty(M.control.NavigationZoomHistory.prototype,"equals",M.control.NavigationZoomHistory.prototype.equals);goog.exportProperty(M.control.NavigationZoomHistory.prototype,"destroy",M.control.NavigationZoomHistory.prototype.destroy); })(window.M);
